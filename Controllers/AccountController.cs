    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                { UserName = model.Email, Email = model.Email, DrivingLicence= model.DrivingLicence, Phone=model.Phone };
               ...
               /*   var roleManager = new RoleManager<IdentityRole>(roleStore);
                  await roleManager.CreateAsync(new IdentityRole("CanManageMovies")); //Assegna il ruolo di gestore dei dati dei film 
